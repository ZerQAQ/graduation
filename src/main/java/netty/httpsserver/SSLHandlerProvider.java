...
public class SSLHandlerProvider {
    ...
    private static final String KEYSTORE= "cert/a.jks";
    private static final String KEYSTORE_TYPE="JKS";      
    private static final String KEYSTORE_PASSWORD= "123456";
    private static final String CERT_PASSWORD="123456";
    private  static SSLContext serverSSLContext =null;

    public static SslHandler getSSLHandler() throws GeneralSecurityException, IOException {
        ...
        String[] certFilesPath = new String[]{
                "E:\\project\\Netty\\cert\\gmssl2\\server.crt",
                "E:\\project\\Netty\\cert\\gmssl2\\ca.crt"
        };

        String privateKeyFilePath = "E:\\project\\Netty\\cert\\gmssl2\\ca.key";

        return new SslHandler(new GmSSLEngine(certFilesPath, privateKeyFilePath));
    }
