...
public class SM2Util {
    ...
    public void loadPrivateKey(String filename) throws GeneralSecurityException, IOException {
        ...
        // 拿到密钥
        this.pubKey = new String(Hex.encode(publicKey.getQ().getEncoded(true)));
        this.prvKey = privateKey.getD().toString(16);
    ...
    public byte[] pubKeyEncrypt(byte[] input)
     ...
     * @return
     */
    public byte[] prvKetDecrypt(byte[] input) throws NoSuchPaddingException, NoSuchAlgorithmException,
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException {
        ...
        try {
            ...
            //String encode = sm2.pubKetEncode(str, pubKey);
